"""
Buổi 07: Module xử lý core RAG Pipeline (Validation, Embedding, Chroma Indexing, Retrieval, Generation & Citation).

Bước 04: Loader và Validator cho dữ liệu chunk JSON.
Bước 05: Gemini Embedding & ChromaDB Persistent Indexing.
Bước 06: Semantic Retrieval, Confidence Gate, LLM Generation & Citation Mapping.
Bước 08: Refactoring & Support Config Injection cho Automated Testing.
"""
...
def generate_embeddings(
    ...
    if not config.get("has_api_key"):
        raise ValueError(
            "Lỗi: Thiếu GEMINI_API_KEY trong file .env. Vui lòng điền API Key hợp lệ vào rag_foundation/buoi_07/.env."
        )
