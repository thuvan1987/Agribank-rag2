"""
Buổi 08: Module Advanced RAG Pipeline (BM25 Lexical Retrieval, Semantic Candidate Retrieval, Reciprocal Rank Fusion, Cross-Encoder Reranker, LLM Generation & Citation).

Module này tích hợp hoàn chỉnh 4 chế độ retrieval (bm25, semantic, hybrid, hybrid_rerank),
xử lý gating, citation mapping, pipeline trace và so sánh đa chế độ.
"""
