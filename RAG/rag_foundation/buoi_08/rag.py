"""
Buổi 08: Semantic Baseline Module (Sao chép và kế thừa độc lập từ rag_foundation/buoi_07/rag.py).

Nguồn baseline: rag_foundation/buoi_07/rag.py
Mục đích: Cung cấp Semantic Candidate Retrieval và baseline pipeline độc lập cho Buổi 08,
sử dụng cấu hình .env và storage Chroma riêng của rag_foundation/buoi_08.
"""
